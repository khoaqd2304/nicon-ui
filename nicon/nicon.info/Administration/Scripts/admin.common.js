...
function MsgSuccess(title, content, timer) {

    var timeId = new Date().getTime();
    var alertBox = "<div id='sknadAlert-" + timeId + "' class='sknadAlert'>";
    alertBox = alertBox + "<div class='sknadAlertTitle'></div>";
    alertBox = alertBox + "<div class='sknadAlertDescription'></div>";
    alertBox = alertBox + "</div>";
    $("body").append(alertBox);

    $("#sknadAlert-" + timeId + " > .sknadAlertTitle").html(title);
    $("#sknadAlert-" + timeId + " > .sknadAlertDescription").html(content);
    $("#sknadAlert-" + timeId).addClass("sknadAlertSuccess");
    $("#sknadAlert-" + timeId).addClass("sknadAlertActive");
    setTimeout(function () {
        $("#sknadAlert-" + timeId).fadeOut("slow");
    }, timer);
    setTimeout(function () {
        $("#sknadAlert-" + timeId + "").remove();
    }, timer + 500);
}

function MsgInfo(title, content, timer) {
    var timeId = new Date().getTime();
    var alertBox = "<div id='sknadAlert-" + timeId + "' class='sknadAlert'>";
    alertBox = alertBox + "<div class='sknadAlertTitle'></div>";
    alertBox = alertBox + "<div class='sknadAlertDescription'></div>";
    ...
    $("#sknadAlert-" + timeId + " > .sknadAlertTitle").html(title);
    $("#sknadAlert-" + timeId + " > .sknadAlertDescription").html(content);
    $("#sknadAlert-" + timeId).addClass("sknadAlertInfo");
    $("#sknadAlert-" + timeId).addClass("sknadAlertActive");
    setTimeout(function () {
        $("#sknadAlert-" + timeId).fadeOut("slow");
    }, timer);
...
function MsgWarning(title, content, timer) {
    var timeId = new Date().getTime();
    var alertBox = "<div id='sknadAlert-" + timeId + "' class='sknadAlert'>";
    alertBox = alertBox + "<div class='sknadAlertTitle'></div>";
    alertBox = alertBox + "<div class='sknadAlertDescription'></div>";
    ...
    $("#sknadAlert-" + timeId + " > .sknadAlertTitle").html(title);
    $("#sknadAlert-" + timeId + " > .sknadAlertDescription").html(content);
    $("#sknadAlert-" + timeId + "").addClass("sknadAlertWarning");
    $("#sknadAlert-" + timeId + "").addClass("sknadAlertActive");
    setTimeout(function () {
        $("#sknadAlert-" + timeId).fadeOut("slow");
    }, timer);
...
function MsgDanger(title, content, timer) {
    var timeId = new Date().getTime();
    var alertBox = "<div id='sknadAlert-" + timeId + "' class='sknadAlert'>";
    alertBox = alertBox + "<div class='sknadAlertTitle'></div>";
    alertBox = alertBox + "<div class='sknadAlertDescription'></div>";
    ...
    $("#sknadAlert-" + timeId + " > .sknadAlertTitle").html(title);
    $(".sknadAlert > .sknadAlertDescription").html(content);
    $("#sknadAlert-" + timeId).addClass("sknadAlertDanger");
    $("#sknadAlert-" + timeId).addClass("sknadAlertActive");
    setTimeout(function () {
        $("#sknadAlert-" + timeId).fadeOut("slow");
    }, timer);
